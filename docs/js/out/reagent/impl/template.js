...
var G__36325 = o;
(G__36325[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__36326__delegate = function (args){
...
return G__36326__delegate.call(this,args);};
...
return G__36326__delegate(args);
});
...
var G__36329 = o;
(G__36329[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__36334 = props;
var G__36334__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__36334,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36334);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__36334__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36335){
...
var props = map__36336__$1;
var class$ = cljs.core.get.call(null,map__36336__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36338){
...
var on_write = cljs.core.get.call(null,map__36339__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__36339,map__36339__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__36339,map__36339__$1,on_write))
);
} else {
...
var G__36342 = jsprops;
(G__36342["defaultValue"] = value);

(G__36342["onChange"] = ((function (G__36342,v,value,on_change){
return (function (p1__36341_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__36341_SHARP_);
});})(G__36342,v,value,on_change))
);
...
var vec__36345 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__36345,(0),null);
var id = cljs.core.nth.call(null,vec__36345,(1),null);
var class$ = cljs.core.nth.call(null,vec__36345,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___36349 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___36349 == null)){
} else {
var key_36350 = temp__5461__auto___36349;
...
var temp__5461__auto___36351 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___36351 == null)){
} else {
var key_36352 = temp__5461__auto___36351;
reagent.impl.template.oset.call(null,jsprops,"key",key_36352);
}
...
var G__36353 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__36353["name"] = c);
...
var len__4499__auto___36358 = arguments.length;
var i__4500__auto___36359 = (0);
while(true){
if((i__4500__auto___36359 < len__4499__auto___36358)){
args__4502__auto__.push((arguments[i__4500__auto___36359]));

var G__36360 = (i__4500__auto___36359 + (1));
i__4500__auto___36359 = G__36360;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36356){
...
break;
default:
var G__36363 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__36363;
continue;
...
var n__4376__auto___36365 = a.length;
var i_36366 = (0);
while(true){
if((i_36366 < n__4376__auto___36365)){
(a[i_36366] = reagent.impl.template.as_element.call(null,(a[i_36366])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___36368 = a.length;
var i_36369 = (0);
while(true){
if((i_36369 < n__4376__auto___36368)){
var val_36370 = (a[i_36369]);
if(((cljs.core.vector_QMARK_.call(null,val_36370)) && ((reagent.impl.template.key_from_vec.call(null,val_36370) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36369] = reagent.impl.template.as_element.call(null,val_36370));
...
var ctx = ({});
var vec__36372 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__36372,(0),null);
var derefed = cljs.core.nth.call(null,vec__36372,(1),null);
...
var G__36375 = (cljs.core.count.call(null,argv) - first_child);
switch (G__36375) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__36375){
