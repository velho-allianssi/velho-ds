...
return cljs.core.assoc.call(null,G__45953,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__45953;
}
});
...
var len__4499__auto___45958 = arguments.length;
var i__4500__auto___45959 = (0);
while(true){
if((i__4500__auto___45959 < len__4499__auto___45958)){
args__4502__auto__.push((arguments[i__4500__auto___45959]));

var G__45960 = (i__4500__auto___45959 + (1));
i__4500__auto___45959 = G__45960;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq45955){
var G__45956 = cljs.core.first.call(null,seq45955);
var seq45955__$1 = cljs.core.next.call(null,seq45955);
var G__45957 = cljs.core.first.call(null,seq45955__$1);
var seq45955__$2 = cljs.core.next.call(null,seq45955__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45956,G__45957,seq45955__$2);
});
...
var line = cljs.core.get.call(null,map__45962__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__45962__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__45962,map__45962__$1,file,line,column){
return (function (p1__45961_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__45961_SHARP_));
});})(map__45962,map__45962__$1,file,line,column))
...
var temp__5457__auto___45964 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___45964)){
var message_45965 = temp__5457__auto___45964;
cljs.core.println.call(null,message_45965);
} else {
}
...
var temp__5457__auto___45966 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___45966)){
var message_45967 = temp__5457__auto___45966;
cljs.core.println.call(null,message_45967);
} else {
}
...
var output_dir = "docs/js/out";
var output_dir__$1 = (function (){var G__45968 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45968),"/"].join('');
} else {
return G__45968;
}
})();
...
var G__45970 = exception.stack;
var G__45970__$1 = (((G__45970 == null))?null:clojure.string.split_lines.call(null,G__45970));
var G__45970__$2 = (((G__45970__$1 == null))?null:cljs.core.get.call(null,G__45970__$1,depth));
if((G__45970__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__45970__$2);
}
} else {
...
var vec__45971 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__45971,(0),null);
var column = cljs.core.nth.call(null,vec__45971,(1),null);
var vec__45974 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__45974,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__45974,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__45974,(2),null);
...
var m__$1 = (function (){var G__45977 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__45981 = (function (){var G__45980 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__45980);
} else {
return G__45980;
}
})();
...
return cljs.core.vary_meta.call(null,G__45982,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__45986 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__45986,(0),null);
var types = vec__45986;
...
return cljs.core.map.call(null,(function (p__45989){
var vec__45990 = p__45989;
var ns = cljs.core.nth.call(null,vec__45990,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__45990,(1),null);
return ((function (vec__45990,ns,vars__$1){
return (function (){
...
var G__45993 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1){
return (function (){
var seq__45994 = cljs.core.seq.call(null,vars__$1);
var chunk__45995 = null;
var count__45996 = (0);
var i__45997 = (0);
while(true){
if((i__45997 < count__45996)){
var v = cljs.core._nth.call(null,chunk__45995,i__45997);
var temp__5457__auto___45999 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___45999)){
var t_46000 = temp__5457__auto___45999;
each_fixture_fn.call(null,((function (seq__45994,chunk__45995,count__45996,i__45997,t_46000,temp__5457__auto___45999,v,each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_46000)));
});})(seq__45994,chunk__45995,count__45996,i__45997,t_46000,temp__5457__auto___45999,v,each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1))
);
} else {
}


var G__46001 = seq__45994;
var G__46002 = chunk__45995;
var G__46003 = count__45996;
var G__46004 = (i__45997 + (1));
seq__45994 = G__46001;
chunk__45995 = G__46002;
count__45996 = G__46003;
i__45997 = G__46004;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__45994);
if(temp__5457__auto__){
var seq__45994__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__45994__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__45994__$1);
var G__46005 = cljs.core.chunk_rest.call(null,seq__45994__$1);
var G__46006 = c__4319__auto__;
var G__46007 = cljs.core.count.call(null,c__4319__auto__);
var G__46008 = (0);
seq__45994 = G__46005;
chunk__45995 = G__46006;
count__45996 = G__46007;
i__45997 = G__46008;
continue;
} else {
var v = cljs.core.first.call(null,seq__45994__$1);
var temp__5457__auto___46009__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___46009__$1)){
var t_46010 = temp__5457__auto___46009__$1;
each_fixture_fn.call(null,((function (seq__45994,chunk__45995,count__45996,i__45997,t_46010,temp__5457__auto___46009__$1,v,seq__45994__$1,temp__5457__auto__,each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_46010)));
});})(seq__45994,chunk__45995,count__45996,i__45997,t_46010,temp__5457__auto___46009__$1,v,seq__45994__$1,temp__5457__auto__,each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1))
);
} else {
}


var G__46011 = cljs.core.next.call(null,seq__45994__$1);
var G__46012 = null;
var G__46013 = (0);
var G__46014 = (0);
seq__45994 = G__46011;
chunk__45995 = G__46012;
count__45996 = G__46013;
i__45997 = G__46014;
continue;
}
} else {
...
});})(each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1))
);
});})(each_fixture_fn,G__45993,G__45993__$1,env,once_fixtures,each_fixtures,vec__45990,ns,vars__$1))
], null);
