...
var o40292 = temp__5455__auto__;
var temp__5455__auto____$1 = (o40292["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o40293 = temp__5455__auto____$1;
return (o40293["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39404__auto__ = f;
return (o__39404__auto__["toString"]).call(o__39404__auto__);
} else {
return "";
}
...
try{var o__39404__auto___40296 = t;
(o__39404__auto___40296["cljs$lang$ctorPrWriter"]).call(o__39404__auto___40296,t,writer);
}catch (e40295){var __40297 = e40295;
}
...
var char_code = (function (){var o__39404__auto__ = (new String(char$));
return (o__39404__auto__["charCodeAt"]).call(o__39404__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39404__auto__ = String;
return (o__39404__auto__["fromCharCode"]).call(o__39404__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40298 = num_code;
switch (G__40298) {
case (1):
return (185);
...
var o__39404__auto__ = String;
return (o__39404__auto__["fromCharCode"]).call(o__39404__auto__,superscript_code);
});
/**
...
}catch (e40300){var _e__39411__auto__ = e40300;
return false;
}})())){
...
var vec__40301 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40301,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o40304 = temp__5455__auto__;
var temp__5455__auto____$1 = (o40304["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o40305 = temp__5455__auto____$1;
return (o40305["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___40312 = arguments.length;
var i__4500__auto___40313 = (0);
while(true){
if((i__4500__auto___40313 < len__4499__auto___40312)){
args__4502__auto__.push((arguments[i__4500__auto___40313]));

var G__40314 = (i__4500__auto___40313 + (1));
i__4500__auto___40313 = G__40314;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40308){
var vec__40309 = p__40308;
var ns_detector = cljs.core.nth.call(null,vec__40309,(0),null);
...
var G__40315 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40316 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40315;
remaining_tokens = G__40316;
continue;
}
}
break;
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40307,seq40306__$1);
});
...
var vec__40320 = cljs.core.split_with.call(null,(function (p1__40319_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40319_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40320,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40320,(1),null);
...
var vec__40323 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40323,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40323,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40326 = cljs.core.rest.call(null,remaining_tokens);
var G__40327 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40326;
name_tokens = G__40327;
continue;
} else {
...
var vec__40330 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40330,(0),null);
var arity = cljs.core.nth.call(null,vec__40330,(1),null);
var vec__40333 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40333,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40333,(1),null);
var vec__40336 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40336,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40336,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40336,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40336,(3),null);
...
var vec__40342 = result;
var munged_ns = cljs.core.nth.call(null,vec__40342,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40342,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40342,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40342,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40342,(4),null);
var arity = cljs.core.nth.call(null,vec__40342,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__40346 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__40346,(0),null);
var args = cljs.core.nth.call(null,vec__40346,(1),null);
var vec__40349 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40349,(0),null);
var name = cljs.core.nth.call(null,vec__40349,(1),null);
...
var G__40352 = (arity + (1));
var G__40353 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40354){
var vec__40355 = p__40354;
var arity = cljs.core.nth.call(null,vec__40355,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40355,(1),null);
...
return cljs.core.get.call(null,arities,p1__40358_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40359_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___40366 = arguments.length;
var i__4500__auto___40367 = (0);
while(true){
if((i__4500__auto___40367 < len__4499__auto___40366)){
args__4502__auto__.push((arguments[i__4500__auto___40367]));

var G__40368 = (i__4500__auto___40367 + (1));
i__4500__auto___40367 = G__40368;
continue;
} else {
}
break;
...
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40363,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40360){
var G__40361 = cljs.core.first.call(null,seq40360);
var seq40360__$1 = cljs.core.next.call(null,seq40360);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40361,seq40360__$1);
});
...
var G__40369 = arg;
var G__40369__$1 = (((G__40369 instanceof cljs.core.Keyword))?G__40369.fqn:null);
switch (G__40369__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__40371__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40371__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40371__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40371__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40372 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40372,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40372,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40372,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40372,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40372,(4),null);
var arity = cljs.core.nth.call(null,vec__40372,(5),null);
...
var o__39404__auto__ = f;
return (o__39404__auto__["getBasis"]).call(o__39404__auto__);
});
/**
...
}catch (e40376){var _e__39411__auto__ = e40376;
...
var G__40377 = (obj[cljs.core.first.call(null,path)]);
var G__40378 = cljs.core.rest.call(null,path);
obj = G__40377;
path = G__40378;
continue;
} else {
...
return (function (accum,p__40379){
var vec__40380 = p__40379;
var bit = cljs.core.nth.call(null,vec__40380,(0),null);
var protocol = cljs.core.nth.call(null,vec__40380,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40383){
var vec__40384 = p__40383;
var ns = cljs.core.nth.call(null,vec__40384,(0),null);
var name = cljs.core.nth.call(null,vec__40384,(1),null);
var selector = cljs.core.nth.call(null,vec__40384,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__40389,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40389,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40389,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40387_SHARP_){
return (obj[cljs.core.first.call(null,p1__40387_SHARP_)]);
});})(name,sorted_matches,vec__40389,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
