...
if((i < len)){
var k = (ks[i]);
var G__12046 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12047 = (i + (1));
m = G__12046;
i = G__12047;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__12048 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__12048) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__12048));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__12050 = c;
var G__12050__$1 = (((G__12050 == null))?null:G__12050.prototype);
if((G__12050__$1 == null)){
return null;
} else {
return (G__12050__$1["reagentRender"]);
}
})() == null))));
});
...
return (function() { 
var G__12056__delegate = function (args){
var G__12054 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12054) : reagent.impl.component.as_element.call(null,G__12054));
};
...
while (G__12057__i < G__12057__a.length) {G__12057__a[G__12057__i] = arguments[G__12057__i + 0]; ++G__12057__i;}
  args = new cljs.core.IndexedSeq(G__12057__a,0,null);
} 
return G__12056__delegate.call(this,args);};
...
return G__12056__delegate(args);
});
...
var _STAR_current_component_STAR_12060 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12060;
}});
...
var G__12061 = key;
var G__12061__$1 = (((G__12061 instanceof cljs.core.Keyword))?G__12061.fqn:null);
switch (G__12061__$1) {
...
return ((function (G__12061,G__12061__$1){
...
var c = this;
var G__12062_12064 = (c["cljsRatom"]);
if((G__12062_12064 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12062_12064);
}
...
var renders_12066 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12067 = cljs.core.first(cljs.core.vals(renders_12066));
if((cljs.core.count(renders_12066) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12066))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12067)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12067], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__12065 = name;
switch (G__12065) {
case "":
...
var G__12070 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__12070) : reagent.impl.component.global$module$create_react_class.call(null,G__12070));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__12071 = fiber;
var G__12071__$1 = (((G__12071 == null))?null:(G__12071["type"]));
if((G__12071__$1 == null)){
return null;
} else {
return (G__12071__$1["displayName"]);
}
})();
var parent = (function (){var G__12072 = fiber;
if((G__12072 == null)){
return null;
} else {
return (G__12072["return"]);
}
})();
var path = (function (){var G__12073 = parent;
var G__12073__$1 = (((G__12073 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__12073) : reagent.impl.component.fiber_component_path.call(null,G__12073)));
if((G__12073__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12073__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__12075 = c;
if((G__12075 == null)){
return null;
} else {
return (G__12075["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__12076._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__12078 = c;
if((G__12078 == null)){
return null;
} else {
return (G__12078["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__12080 = c;
if((G__12080 == null)){
return null;
} else {
return G__12080._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__12082 = instance;
if((G__12082 == null)){
return null;
} else {
return (G__12082["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__12083 = instance;
if((G__12083 == null)){
return null;
} else {
return G__12083._currentElement;
}
}
})();
var name = (function (){var G__12084 = elem;
var G__12084__$1 = (((G__12084 == null))?null:(G__12084["type"]));
if((G__12084__$1 == null)){
return null;
} else {
return (G__12084__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__12086 = elem;
if((G__12086 == null)){
return null;
} else {
return (G__12086["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__12087._owner;
}
}
})();
var path = (function (){var G__12088 = owner;
var G__12088__$1 = (((G__12088 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__12088) : reagent.impl.component.component_path.call(null,G__12088)));
if((G__12088__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12088__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__12089 = c;
var G__12089__$1 = (((G__12089 == null))?null:G__12089.constructor);
if((G__12089__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12089__$1);
}
}
})();
