...
var G__12107 = o;
(G__12107[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12111 = o;
(G__12111[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__12116 = props;
var G__12116__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12116,cljs.core.cst$kw$id,id):G__12116);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12116__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12117){
...
var props = map__12118__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12118__$1,cljs.core.cst$kw$class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12120){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12121__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__12121,map__12121__$1,on_write){
return (function (){
...
});})(node_value,map__12121,map__12121__$1,on_write))
);
} else {
...
var G__12124 = jsprops;
(G__12124["defaultValue"] = value);

(G__12124["onChange"] = ((function (G__12124,v,value,on_change){
return (function (p1__12123_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12123_SHARP_);
});})(G__12124,v,value,on_change))
);
...
var vec__12127 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12127,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12127,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12127,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___12131 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___12131 == null)){
} else {
var key_12132 = temp__5461__auto___12131;
(jsprops["key"] = key_12132);
}
...
var temp__5461__auto___12133 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___12133 == null)){
} else {
var key_12134 = temp__5461__auto___12133;
reagent.impl.template.oset(jsprops,"key",key_12134);
}
...
var G__12135 = reagent.impl.template.__GT_NativeWrapper();
(G__12135["name"] = c);
...
var G__12136 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12136) : reagent.impl.template.as_element.call(null,G__12136));
} else {
...
var len__4499__auto___12141 = arguments.length;
var i__4500__auto___12142 = (0);
while(true){
if((i__4500__auto___12142 < len__4499__auto___12141)){
args__4502__auto__.push((arguments[i__4500__auto___12142]));

var G__12143 = (i__4500__auto___12142 + (1));
i__4500__auto___12142 = G__12143;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12139){
var G__12140 = cljs.core.first(seq12139);
var seq12139__$1 = cljs.core.next(seq12139);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12140,seq12139__$1);
});
...
break;
default:
var G__12146 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12146;
continue;
...
var n__4376__auto___12148 = a.length;
var i_12149 = (0);
while(true){
if((i_12149 < n__4376__auto___12148)){
(a[i_12149] = reagent.impl.template.as_element((a[i_12149])));

var G__12150 = (i_12149 + (1));
i_12149 = G__12150;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___12151 = a.length;
var i_12152 = (0);
while(true){
if((i_12152 < n__4376__auto___12151)){
var val_12153 = (a[i_12152]);
if(((cljs.core.vector_QMARK_(val_12153)) && ((reagent.impl.template.key_from_vec(val_12153) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12152] = reagent.impl.template.as_element(val_12153));

var G__12154 = (i_12152 + (1));
i_12152 = G__12154;
continue;
} else {
}
...
var ctx = ({});
var vec__12155 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12155,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12155,(1),null);
...
var G__12158 = (cljs.core.count(argv) - first_child);
switch (G__12158) {
case (0):
...
case (1):
var G__12159 = comp;
var G__12160 = jsprops;
var G__12161 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__12159,G__12160,G__12161) : reagent.impl.template.global$module$react.createElement.call(null,G__12159,G__12160,G__12161));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__12158){
