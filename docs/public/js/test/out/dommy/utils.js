 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__36546){
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__36550 = cljs.core.namespace.call(null,s);
if((G__36550 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36550),"/"].join('');
}
...
var G__36552 = (function (){var end = (i + class$.length);
