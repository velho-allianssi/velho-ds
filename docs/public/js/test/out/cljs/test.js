...
var G__42877 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__42877,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__42877;
}
});
...
var len__4499__auto___42882 = arguments.length;
var i__4500__auto___42883 = (0);
while(true){
if((i__4500__auto___42883 < len__4499__auto___42882)){
args__4502__auto__.push((arguments[i__4500__auto___42883]));

var G__42884 = (i__4500__auto___42883 + (1));
i__4500__auto___42883 = G__42884;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42879){
var G__42880 = cljs.core.first.call(null,seq42879);
var seq42879__$1 = cljs.core.next.call(null,seq42879);
var G__42881 = cljs.core.first.call(null,seq42879__$1);
var seq42879__$2 = cljs.core.next.call(null,seq42879__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42880,G__42881,seq42879__$2);
});
...
var map__42886 = m;
var map__42886__$1 = ((((!((map__42886 == null)))?(((((map__42886.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42886.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42886):map__42886);
var file = cljs.core.get.call(null,map__42886__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__42886__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42886__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__42886,map__42886__$1,file,line,column){
return (function (p1__42885_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__42885_SHARP_));
});})(map__42886,map__42886__$1,file,line,column))
...
var temp__5457__auto___42888 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___42888)){
var message_42889 = temp__5457__auto___42888;
cljs.core.println.call(null,message_42889);
} else {
}
...
var output_dir__$1 = (function (){var G__42892 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42892),"/"].join('');
} else {
return G__42892;
}
})();
...
var G__42894 = exception.stack;
var G__42894__$1 = (((G__42894 == null))?null:clojure.string.split_lines.call(null,G__42894));
var G__42894__$2 = (((G__42894__$1 == null))?null:cljs.core.get.call(null,G__42894__$1,depth));
if((G__42894__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42894__$2);
}
} else {
...
var vec__42895 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__42895,(0),null);
var column = cljs.core.nth.call(null,vec__42895,(1),null);
var vec__42898 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__42898,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__42898,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__42898,(2),null);
...
var m__$1 = (function (){var G__42901 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__42905 = (function (){var G__42904 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__42904);
} else {
return G__42904;
}
})();
...
return cljs.core.vary_meta.call(null,G__42906,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__42908 = e;
var G__42908__$1 = (((G__42908 instanceof cljs.core.Keyword))?G__42908.fqn:null);
switch (G__42908__$1) {
...
var vec__42910 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__42910,(0),null);
var types = vec__42910;
...
return cljs.core.map.call(null,(function (p__42913){
var vec__42914 = p__42913;
var ns = cljs.core.nth.call(null,vec__42914,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__42914,(1),null);
return ((function (vec__42914,ns,vars__$1){
return (function (){
...
var G__42917 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1){
return (function (){
var seq__42918 = cljs.core.seq.call(null,vars__$1);
var chunk__42919 = null;
var count__42920 = (0);
var i__42921 = (0);
while(true){
if((i__42921 < count__42920)){
var v = cljs.core._nth.call(null,chunk__42919,i__42921);
var temp__5457__auto___42923 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42923)){
var t_42924 = temp__5457__auto___42923;
each_fixture_fn.call(null,((function (seq__42918,chunk__42919,count__42920,i__42921,t_42924,temp__5457__auto___42923,v,each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42924)));
});})(seq__42918,chunk__42919,count__42920,i__42921,t_42924,temp__5457__auto___42923,v,each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1))
);
} else {
}


var G__42925 = seq__42918;
var G__42926 = chunk__42919;
var G__42927 = count__42920;
var G__42928 = (i__42921 + (1));
seq__42918 = G__42925;
chunk__42919 = G__42926;
count__42920 = G__42927;
i__42921 = G__42928;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__42918);
if(temp__5457__auto__){
var seq__42918__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__42918__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__42918__$1);
var G__42929 = cljs.core.chunk_rest.call(null,seq__42918__$1);
var G__42930 = c__4319__auto__;
var G__42931 = cljs.core.count.call(null,c__4319__auto__);
var G__42932 = (0);
seq__42918 = G__42929;
chunk__42919 = G__42930;
count__42920 = G__42931;
i__42921 = G__42932;
continue;
} else {
var v = cljs.core.first.call(null,seq__42918__$1);
var temp__5457__auto___42933__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42933__$1)){
var t_42934 = temp__5457__auto___42933__$1;
each_fixture_fn.call(null,((function (seq__42918,chunk__42919,count__42920,i__42921,t_42934,temp__5457__auto___42933__$1,v,seq__42918__$1,temp__5457__auto__,each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42934)));
});})(seq__42918,chunk__42919,count__42920,i__42921,t_42934,temp__5457__auto___42933__$1,v,seq__42918__$1,temp__5457__auto__,each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1))
);
} else {
}


var G__42935 = cljs.core.next.call(null,seq__42918__$1);
var G__42936 = null;
var G__42937 = (0);
var G__42938 = (0);
seq__42918 = G__42935;
chunk__42919 = G__42936;
count__42920 = G__42937;
i__42921 = G__42938;
continue;
}
} else {
...
});})(each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1))
);
});})(each_fixture_fn,G__42917,G__42917__$1,env,once_fixtures,each_fixtures,vec__42914,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42917__$1)].join('')));

}
})());
});
;})(vec__42914,ns,vars__$1))
