...
var G__42857 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__42857,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__42857;
}
});
...
var len__4499__auto___42862 = arguments.length;
var i__4500__auto___42863 = (0);
while(true){
if((i__4500__auto___42863 < len__4499__auto___42862)){
args__4502__auto__.push((arguments[i__4500__auto___42863]));

var G__42864 = (i__4500__auto___42863 + (1));
i__4500__auto___42863 = G__42864;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42859){
var G__42860 = cljs.core.first.call(null,seq42859);
var seq42859__$1 = cljs.core.next.call(null,seq42859);
var G__42861 = cljs.core.first.call(null,seq42859__$1);
var seq42859__$2 = cljs.core.next.call(null,seq42859__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42860,G__42861,seq42859__$2);
});
...
var file = cljs.core.get.call(null,map__42866__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__42866__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42866__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__42866,map__42866__$1,file,line,column){
return (function (p1__42865_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__42865_SHARP_));
});})(map__42866,map__42866__$1,file,line,column))
...
var temp__5457__auto___42868 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___42868)){
var message_42869 = temp__5457__auto___42868;
cljs.core.println.call(null,message_42869);
} else {
}
...
var output_dir__$1 = (function (){var G__42872 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42872),"/"].join('');
} else {
return G__42872;
}
})();
...
var G__42874 = exception.stack;
var G__42874__$1 = (((G__42874 == null))?null:clojure.string.split_lines.call(null,G__42874));
var G__42874__$2 = (((G__42874__$1 == null))?null:cljs.core.get.call(null,G__42874__$1,depth));
if((G__42874__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42874__$2);
}
} else {
...
var vec__42875 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__42875,(0),null);
var column = cljs.core.nth.call(null,vec__42875,(1),null);
var vec__42878 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__42878,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__42878,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__42878,(2),null);
...
var m__$1 = (function (){var G__42881 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__42881__$1 = (((G__42881 instanceof cljs.core.Keyword))?G__42881.fqn:null);
switch (G__42881__$1) {
case "fail":
...
var G__42885 = (function (){var G__42884 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__42884);
} else {
return G__42884;
}
})();
...
return cljs.core.vary_meta.call(null,G__42886,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__42890 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__42890,(0),null);
var types = vec__42890;
...
return cljs.core.map.call(null,(function (p__42893){
var vec__42894 = p__42893;
var ns = cljs.core.nth.call(null,vec__42894,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__42894,(1),null);
return ((function (vec__42894,ns,vars__$1){
return (function (){
...
var G__42897 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__42897__$1 = (((G__42897 instanceof cljs.core.Keyword))?G__42897.fqn:null);
switch (G__42897__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1){
return (function (){
var seq__42898 = cljs.core.seq.call(null,vars__$1);
var chunk__42899 = null;
var count__42900 = (0);
var i__42901 = (0);
while(true){
if((i__42901 < count__42900)){
var v = cljs.core._nth.call(null,chunk__42899,i__42901);
var temp__5457__auto___42903 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42903)){
var t_42904 = temp__5457__auto___42903;
each_fixture_fn.call(null,((function (seq__42898,chunk__42899,count__42900,i__42901,t_42904,temp__5457__auto___42903,v,each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42904)));
});})(seq__42898,chunk__42899,count__42900,i__42901,t_42904,temp__5457__auto___42903,v,each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1))
);
} else {
}


var G__42905 = seq__42898;
var G__42906 = chunk__42899;
var G__42907 = count__42900;
var G__42908 = (i__42901 + (1));
seq__42898 = G__42905;
chunk__42899 = G__42906;
count__42900 = G__42907;
i__42901 = G__42908;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__42898);
if(temp__5457__auto__){
var seq__42898__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__42898__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__42898__$1);
var G__42909 = cljs.core.chunk_rest.call(null,seq__42898__$1);
var G__42910 = c__4319__auto__;
var G__42911 = cljs.core.count.call(null,c__4319__auto__);
var G__42912 = (0);
seq__42898 = G__42909;
chunk__42899 = G__42910;
count__42900 = G__42911;
i__42901 = G__42912;
continue;
} else {
var v = cljs.core.first.call(null,seq__42898__$1);
var temp__5457__auto___42913__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42913__$1)){
var t_42914 = temp__5457__auto___42913__$1;
each_fixture_fn.call(null,((function (seq__42898,chunk__42899,count__42900,i__42901,t_42914,temp__5457__auto___42913__$1,v,seq__42898__$1,temp__5457__auto__,each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42914)));
});})(seq__42898,chunk__42899,count__42900,i__42901,t_42914,temp__5457__auto___42913__$1,v,seq__42898__$1,temp__5457__auto__,each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1))
);
} else {
}


var G__42915 = cljs.core.next.call(null,seq__42898__$1);
var G__42916 = null;
var G__42917 = (0);
var G__42918 = (0);
seq__42898 = G__42915;
chunk__42899 = G__42916;
count__42900 = G__42917;
i__42901 = G__42918;
continue;
}
} else {
...
});})(each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1))
);
});})(each_fixture_fn,G__42897,G__42897__$1,env,once_fixtures,each_fixtures,vec__42894,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42897__$1)].join('')));

}
})());
});
;})(vec__42894,ns,vars__$1))
