...
var G__42862 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__42862,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__42862;
}
});
...
var i__4500__auto___42868 = (0);
while(true){
if((i__4500__auto___42868 < len__4499__auto___42867)){
args__4502__auto__.push((arguments[i__4500__auto___42868]));

var G__42869 = (i__4500__auto___42868 + (1));
i__4500__auto___42868 = G__42869;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42864){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42865,G__42866,seq42864__$2);
});
...
var file = cljs.core.get.call(null,map__42871__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__42871__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42871__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__42871,map__42871__$1,file,line,column){
return (function (p1__42870_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__42870_SHARP_));
});})(map__42871,map__42871__$1,file,line,column))
...
var temp__5457__auto___42873 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___42873)){
var message_42874 = temp__5457__auto___42873;
cljs.core.println.call(null,message_42874);
} else {
}
...
var temp__5457__auto___42875 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___42875)){
var message_42876 = temp__5457__auto___42875;
cljs.core.println.call(null,message_42876);
} else {
}
...
var output_dir__$1 = (function (){var G__42877 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42877),"/"].join('');
} else {
return G__42877;
}
})();
...
var G__42879 = exception.stack;
var G__42879__$1 = (((G__42879 == null))?null:clojure.string.split_lines.call(null,G__42879));
var G__42879__$2 = (((G__42879__$1 == null))?null:cljs.core.get.call(null,G__42879__$1,depth));
if((G__42879__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42879__$2);
}
} else {
...
var vec__42880 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__42880,(0),null);
var column = cljs.core.nth.call(null,vec__42880,(1),null);
var vec__42883 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__42883,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__42883,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__42883,(2),null);
...
var m__$1 = (function (){var G__42886 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__42890 = (function (){var G__42889 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__42889);
} else {
return G__42889;
}
})();
...
return cljs.core.vary_meta.call(null,G__42891,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__42895 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__42895,(0),null);
var types = vec__42895;
...
return cljs.core.map.call(null,(function (p__42898){
var vec__42899 = p__42898;
var ns = cljs.core.nth.call(null,vec__42899,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__42899,(1),null);
return ((function (vec__42899,ns,vars__$1){
return (function (){
...
var G__42902 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1){
return (function (){
var seq__42903 = cljs.core.seq.call(null,vars__$1);
var chunk__42904 = null;
var count__42905 = (0);
var i__42906 = (0);
while(true){
if((i__42906 < count__42905)){
var v = cljs.core._nth.call(null,chunk__42904,i__42906);
var temp__5457__auto___42908 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42908)){
var t_42909 = temp__5457__auto___42908;
each_fixture_fn.call(null,((function (seq__42903,chunk__42904,count__42905,i__42906,t_42909,temp__5457__auto___42908,v,each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42909)));
});})(seq__42903,chunk__42904,count__42905,i__42906,t_42909,temp__5457__auto___42908,v,each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1))
);
} else {
}


var G__42910 = seq__42903;
var G__42911 = chunk__42904;
var G__42912 = count__42905;
var G__42913 = (i__42906 + (1));
seq__42903 = G__42910;
chunk__42904 = G__42911;
count__42905 = G__42912;
i__42906 = G__42913;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__42903);
if(temp__5457__auto__){
var seq__42903__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__42903__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__42903__$1);
var G__42914 = cljs.core.chunk_rest.call(null,seq__42903__$1);
var G__42915 = c__4319__auto__;
var G__42916 = cljs.core.count.call(null,c__4319__auto__);
var G__42917 = (0);
seq__42903 = G__42914;
chunk__42904 = G__42915;
count__42905 = G__42916;
i__42906 = G__42917;
continue;
} else {
var v = cljs.core.first.call(null,seq__42903__$1);
var temp__5457__auto___42918__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42918__$1)){
var t_42919 = temp__5457__auto___42918__$1;
each_fixture_fn.call(null,((function (seq__42903,chunk__42904,count__42905,i__42906,t_42919,temp__5457__auto___42918__$1,v,seq__42903__$1,temp__5457__auto__,each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42919)));
});})(seq__42903,chunk__42904,count__42905,i__42906,t_42919,temp__5457__auto___42918__$1,v,seq__42903__$1,temp__5457__auto__,each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1))
);
} else {
}


var G__42920 = cljs.core.next.call(null,seq__42903__$1);
var G__42921 = null;
var G__42922 = (0);
var G__42923 = (0);
seq__42903 = G__42920;
chunk__42904 = G__42921;
count__42905 = G__42922;
i__42906 = G__42923;
continue;
}
} else {
...
});})(each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1))
);
});})(each_fixture_fn,G__42902,G__42902__$1,env,once_fixtures,each_fixtures,vec__42899,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42902__$1)].join('')));

}
})());
});
;})(vec__42899,ns,vars__$1))
