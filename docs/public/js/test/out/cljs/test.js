...
var G__42876 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__42876,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__42876;
}
});
...
var len__4499__auto___42881 = arguments.length;
var i__4500__auto___42882 = (0);
while(true){
if((i__4500__auto___42882 < len__4499__auto___42881)){
args__4502__auto__.push((arguments[i__4500__auto___42882]));

var G__42883 = (i__4500__auto___42882 + (1));
i__4500__auto___42882 = G__42883;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42878){
var G__42879 = cljs.core.first.call(null,seq42878);
var seq42878__$1 = cljs.core.next.call(null,seq42878);
var G__42880 = cljs.core.first.call(null,seq42878__$1);
var seq42878__$2 = cljs.core.next.call(null,seq42878__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42879,G__42880,seq42878__$2);
});
...
var line = cljs.core.get.call(null,map__42885__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42885__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__42885,map__42885__$1,file,line,column){
return (function (p1__42884_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__42884_SHARP_));
});})(map__42885,map__42885__$1,file,line,column))
...
var temp__5457__auto___42887 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___42887)){
var message_42888 = temp__5457__auto___42887;
cljs.core.println.call(null,message_42888);
} else {
}
...
var temp__5457__auto___42889 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___42889)){
var message_42890 = temp__5457__auto___42889;
cljs.core.println.call(null,message_42890);
} else {
}
...
var output_dir__$1 = (function (){var G__42891 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42891),"/"].join('');
} else {
return G__42891;
}
})();
...
var G__42893 = exception.stack;
var G__42893__$1 = (((G__42893 == null))?null:clojure.string.split_lines.call(null,G__42893));
var G__42893__$2 = (((G__42893__$1 == null))?null:cljs.core.get.call(null,G__42893__$1,depth));
if((G__42893__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42893__$2);
}
} else {
...
var vec__42894 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__42894,(0),null);
var column = cljs.core.nth.call(null,vec__42894,(1),null);
var vec__42897 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__42897,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__42897,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__42897,(2),null);
...
var m__$1 = (function (){var G__42900 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__42904 = (function (){var G__42903 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__42903);
} else {
return G__42903;
}
})();
...
return cljs.core.vary_meta.call(null,G__42905,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__42909 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__42909,(0),null);
var types = vec__42909;
...
return cljs.core.map.call(null,(function (p__42912){
var vec__42913 = p__42912;
var ns = cljs.core.nth.call(null,vec__42913,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__42913,(1),null);
return ((function (vec__42913,ns,vars__$1){
return (function (){
...
var G__42916 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1){
return (function (){
var seq__42917 = cljs.core.seq.call(null,vars__$1);
var chunk__42918 = null;
var count__42919 = (0);
var i__42920 = (0);
while(true){
if((i__42920 < count__42919)){
var v = cljs.core._nth.call(null,chunk__42918,i__42920);
var temp__5457__auto___42922 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42922)){
var t_42923 = temp__5457__auto___42922;
each_fixture_fn.call(null,((function (seq__42917,chunk__42918,count__42919,i__42920,t_42923,temp__5457__auto___42922,v,each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42923)));
});})(seq__42917,chunk__42918,count__42919,i__42920,t_42923,temp__5457__auto___42922,v,each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1))
);
} else {
}


var G__42924 = seq__42917;
var G__42925 = chunk__42918;
var G__42926 = count__42919;
var G__42927 = (i__42920 + (1));
seq__42917 = G__42924;
chunk__42918 = G__42925;
count__42919 = G__42926;
i__42920 = G__42927;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__42917);
if(temp__5457__auto__){
var seq__42917__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__42917__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__42917__$1);
var G__42928 = cljs.core.chunk_rest.call(null,seq__42917__$1);
var G__42929 = c__4319__auto__;
var G__42930 = cljs.core.count.call(null,c__4319__auto__);
var G__42931 = (0);
seq__42917 = G__42928;
chunk__42918 = G__42929;
count__42919 = G__42930;
i__42920 = G__42931;
continue;
} else {
var v = cljs.core.first.call(null,seq__42917__$1);
var temp__5457__auto___42932__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___42932__$1)){
var t_42933 = temp__5457__auto___42932__$1;
each_fixture_fn.call(null,((function (seq__42917,chunk__42918,count__42919,i__42920,t_42933,temp__5457__auto___42932__$1,v,seq__42917__$1,temp__5457__auto__,each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42933)));
});})(seq__42917,chunk__42918,count__42919,i__42920,t_42933,temp__5457__auto___42932__$1,v,seq__42917__$1,temp__5457__auto__,each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1))
);
} else {
}


var G__42934 = cljs.core.next.call(null,seq__42917__$1);
var G__42935 = null;
var G__42936 = (0);
var G__42937 = (0);
seq__42917 = G__42934;
chunk__42918 = G__42935;
count__42919 = G__42936;
i__42920 = G__42937;
continue;
}
} else {
...
});})(each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1))
);
});})(each_fixture_fn,G__42916,G__42916__$1,env,once_fixtures,each_fixtures,vec__42913,ns,vars__$1))
], null);
