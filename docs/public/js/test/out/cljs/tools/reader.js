...
var G__35611 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__35611;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__35612 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__35612,ch);
...
if(("\\" === ch__$1)){
var ch_35613__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_35613__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_35613__$2);
} else {
}

var G__35614 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__35614;
continue;
}
}
...
var G__35625 = cljs.core.conj_BANG_.call(null,a,form);
a = G__35625;
continue;
}
}
...
var _STAR_read_delim_STAR_35626 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_35626;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__35627 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__35627,(0),null);
var start_column = cljs.core.nth.call(null,vec__35627,(1),null);
...
var vec__35630 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__35630,(0),null);
var end_column = cljs.core.nth.call(null,vec__35630,(1),null);
...
var vec__35639 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__35639,(0),null);
var start_column = cljs.core.nth.call(null,vec__35639,(1),null);
...
var vec__35642 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__35642,(0),null);
var end_column = cljs.core.nth.call(null,vec__35642,(1),null);
...
var sb = (function (){var G__35645 = (new goog.string.StringBuffer());
G__35645.append(initch);
...
var G__35647 = (function (){var G__35646 = sb;
G__35646.append(ch);

return G__35646;
})();
var G__35648 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__35647;
ch = G__35648;
continue;
}
...
var vec__35659 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__35659,(0),null);
var end_column = cljs.core.nth.call(null,vec__35659,(1),null);
...
var vec__35662 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__35662,(0),null);
var column = cljs.core.nth.call(null,vec__35662,(1),null);
...
var vec__35667 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__35667,(0),null);
var column = cljs.core.nth.call(null,vec__35667,(1),null);
...
var line = cljs.core.nth.call(null,vec__35672,(0),null);
var column = cljs.core.nth.call(null,vec__35672,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__35677 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__35677,(0),null);
var start_column = cljs.core.nth.call(null,vec__35677,(1),null);
...
var vec__35680 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__35680,(0),null);
var end_column = cljs.core.nth.call(null,vec__35680,(1),null);
...
var G__35683 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__35683,true,null,opts,pending_forms);
...
var G__35684 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__35684)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__35684)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__35684)){
...
var _STAR_suppress_read_STAR_35685 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_35685;
}});
...
var G__35686 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__35686,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__35686,rdr,first_line);
...
var G__35690 = matched;
var G__35691 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__35690;
finished = G__35691;
continue;
} else {
...
var _STAR_suppress_read_STAR_35692 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_35692;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env35693 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__35694 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__35694,"(");
...
var G__35695 = (i + (1));
var G__35696 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env35693;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__35697 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__35697);
...
var G__35698 = cljs.core.next.call(null,s__$1);
var G__35699 = ret;
s__$1 = G__35698;
r = G__35699;
continue;
...
var G__35700 = cljs.core.next.call(null,s);
var G__35701 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__35700;
key_vals = G__35701;
continue;
} else {
...
var gensym_env35705 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env35705;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__35706 = token;
var G__35706__$1 = (((G__35706 == null))?null:cljs.core.subs.call(null,G__35706,(1)));
var G__35706__$2 = (((G__35706__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__35706__$1));
var G__35706__$3 = (((G__35706__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__35706__$2));
var G__35706__$4 = (((G__35706__$3 == null))?null:cljs.core.symbol.call(null,G__35706__$3));
if((G__35706__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__35706__$4);
}
})():(function (){var G__35707 = token;
var G__35707__$1 = (((G__35707 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__35707));
if((G__35707__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__35707__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__35718,reader){
...
var eof = cljs.core.get.call(null,map__35719__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___35727 = arguments.length;
var i__4500__auto___35728 = (0);
while(true){
if((i__4500__auto___35728 < len__4499__auto___35727)){
args__4502__auto__.push((arguments[i__4500__auto___35728]));

var G__35729 = (i__4500__auto___35728 + (1));
i__4500__auto___35728 = G__35729;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq35725){
var G__35726 = cljs.core.first.call(null,seq35725);
var seq35725__$1 = cljs.core.next.call(null,seq35725);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35726,seq35725__$1);
});
