...
velho_ds.molecules.field.iconvalue = (function velho_ds$molecules$field$iconvalue(p__42938){
...
var icon = cljs.core.get.call(null,map__42939__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var content = cljs.core.get.call(null,map__42939__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
velho_ds.molecules.field.input_field = (function velho_ds$molecules$field$input_field(p__42942){
...
var label = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var content = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"content","content",15833224));
var placeholder = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var icon = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var icon_click_fn = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"icon-click-fn","icon-click-fn",1693089025));
var on_change_fn = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"on-change-fn","on-change-fn",-1237394275));
var on_blur_fn = cljs.core.get.call(null,map__42943__$1,new cljs.core.Keyword(null,"on-blur-fn","on-blur-fn",1587769433));
var input_text = reagent.core.atom.call(null,content);
var change = ((function (input_text,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn){
return (function (val){
...
});})(input_text,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn))
;
var blur = ((function (input_text,change,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn){
return (function (){
...
});})(input_text,change,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn))
;
return ((function (input_text,change,blur,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn){
...
var error_messages = cljs.core.get.call(null,map__42946__$1,new cljs.core.Keyword(null,"error-messages","error-messages",2083896366));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.vds-input-field","div.vds-input-field",353231436),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.element),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),stylefy.core.use_style.call(null,cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.first.call(null,error_messages))?velho_ds.molecules.style.field.input_field_error:velho_ds.molecules.style.field.input_field),(cljs.core.truth_(icon)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),"2.5rem"], null):null)),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"required","required",1807647006),"required",new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__42946,map__42946__$1,error_messages,input_text,change,blur,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn){
return (function (p1__42941_SHARP_){
return change.call(null,p1__42941_SHARP_.target.value);
});})(map__42946,map__42946__$1,error_messages,input_text,change,blur,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42951),velho_ds$molecules$field$input_field_$_iter__42948.call(null,cljs.core.chunk_rest.call(null,s__42949__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42951),null);
}
} else {
var message = cljs.core.first.call(null,s__42949__$2);
return cljs.core.cons.call(null,cljs.core.into.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),stylefy.core.use_sub_style.call(null,velho_ds.molecules.style.field.validation_errors,new cljs.core.Keyword(null,"p","p",151049309)),message], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),message], null))),velho_ds$molecules$field$input_field_$_iter__42948.call(null,cljs.core.rest.call(null,s__42949__$2)));
}
} else {
return null;
}
...
;})(input_text,change,blur,map__42943,map__42943__$1,label,content,placeholder,icon,icon_click_fn,on_change_fn,on_blur_fn))
});
...
velho_ds.molecules.field.dropdown_menu = (function velho_ds$molecules$field$dropdown_menu(p__42958){
...
var label = cljs.core.get.call(null,map__42959__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var selected_fn = cljs.core.get.call(null,map__42959__$1,new cljs.core.Keyword(null,"selected-fn","selected-fn",-245239586));
var options = cljs.core.get.call(null,map__42959__$1,new cljs.core.Keyword(null,"options","options",99638489));
var default_value = cljs.core.get.call(null,map__42959__$1,new cljs.core.Keyword(null,"default-value","default-value",232220170));
var no_selection_text = cljs.core.get.call(null,map__42959__$1,new cljs.core.Keyword(null,"no-selection-text","no-selection-text",629753203));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.element),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_label),label], null),cljs.core.into.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),"value",new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__42959,map__42959__$1,label,selected_fn,options,default_value,no_selection_text){
return (function (p1__42956_SHARP_){
return selected_fn.call(null,p1__42956_SHARP_.target.value);
});})(map__42959,map__42959__$1,label,selected_fn,options,default_value,no_selection_text))
], null)),((cljs.core.not.call(null,default_value))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),"value",new cljs.core.Keyword(null,"disabled","disabled",-1529784218),"disabled"], null),no_selection_text], null):null)], null),cljs.core.mapv.call(null,((function (map__42959,map__42959__$1,label,selected_fn,options,default_value,no_selection_text){
return (function (p1__42957_SHARP_){
return (new cljs.core.PersistentVector(null,3,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"option","option",65132272),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__42957_SHARP_)], null),((cljs.core._EQ_.call(null,default_value,p1__42957_SHARP_))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"selected","selected",574897764),"selected"], null):null)),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__42957_SHARP_)],null));
});})(map__42959,map__42959__$1,label,selected_fn,options,default_value,no_selection_text))
,options)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [velho_ds.atoms.icon.icon,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"arrow_drop_down",new cljs.core.Keyword(null,"styles","styles",1954480375),velho_ds.molecules.style.field.icon], null)], null)], null)], null);
});
velho_ds.molecules.field.list_item = (function velho_ds$molecules$field$list_item(p__42961){
...
velho_ds.molecules.field.selected_list_items = (function velho_ds$molecules$field$selected_list_items(p__42964){
...
return cljs.core.filter.call(null,(function (p1__42967_SHARP_){
return clojure.string.includes_QMARK_.call(null,clojure.string.lower_case.call(null,p1__42967_SHARP_),search_word);
}),collection);
});
...
velho_ds.molecules.field.dropdown_multiple = (function velho_ds$molecules$field$dropdown_multiple(p__42976){
...
var label = cljs.core.get.call(null,map__42977__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var placeholder = cljs.core.get.call(null,map__42977__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var selected_fn = cljs.core.get.call(null,map__42977__$1,new cljs.core.Keyword(null,"selected-fn","selected-fn",-245239586));
var options = cljs.core.get.call(null,map__42977__$1,new cljs.core.Keyword(null,"options","options",99638489));
var preselected_values = cljs.core.get.call(null,map__42977__$1,new cljs.core.Keyword(null,"preselected-values","preselected-values",-1336486963));
...
var input_value_changed_fn = ((function (state,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42968_SHARP_){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"input-text","input-text",-1336297114),p1__42968_SHARP_);
});})(state,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var list_item_selected_fn = ((function (state,input_value_changed_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42969_SHARP_){
cljs.core.swap_BANG_.call(null,state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"selected-items","selected-items",-558712488)], null),cljs.core.conj,p1__42969_SHARP_);
...
});})(state,input_value_changed_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var selected_list_item_selected_fn = ((function (state,input_value_changed_fn,list_item_selected_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42970_SHARP_){
cljs.core.swap_BANG_.call(null,state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"selected-items","selected-items",-558712488)], null),velho_ds.molecules.field.remove_from_vector,p1__42970_SHARP_);

return selected_fn.call(null,new cljs.core.Keyword(null,"selected-items","selected-items",-558712488).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,state)));
});})(state,input_value_changed_fn,list_item_selected_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var selectable_items = ((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (){
...
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var filtered_selections = ((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (){
...
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var key_press_handler_fn = ((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (key){
...
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var global_click_handler = ((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42971_SHARP_){
var target = p1__42971_SHARP_.target;
...
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
var addEventListener = ((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (){
return document.getElementById("app").addEventListener("click",global_click_handler);
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
;
return ((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"position","position",-2011731912),"relative"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"dropdown-multi"], null)),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding-top","padding-top",1929675955),"1rem"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"dropdown-multi"], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_label),label], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"dropdown-multi"], null),cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_multiple_selected_items,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"dropdown-multi"], null))], null),cljs.core.mapv.call(null,((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42972_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[velho_ds.molecules.field.selected_list_items,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),selected_list_item_selected_fn,new cljs.core.Keyword(null,"content","content",15833224),p1__42972_SHARP_], null)],null));
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
,new cljs.core.Keyword(null,"selected-items","selected-items",-558712488).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,state))))], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_multiple_input_background,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"dropdown-multi"], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_multiple_input,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42973_SHARP_){
return input_value_changed_fn.call(null,p1__42973_SHARP_.target.value);
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (p1__42974_SHARP_){
return key_press_handler_fn.call(null,p1__42974_SHARP_.key);
});})(state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values))
,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624),((function (state,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,global_click_handler,addEventListener,map__42977,map__42977__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42985),velho_ds$molecules$field$file_list_item_$_iter__42982.call(null,cljs.core.chunk_rest.call(null,s__42983__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42985),null);
}
} else {
var meta_key = cljs.core.first.call(null,s__42983__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [velho_ds.molecules.field.input_field,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),clojure.string.capitalize.call(null,cljs.core.name.call(null,meta_key)),new cljs.core.Keyword(null,"content","content",15833224),cljs.core.get.call(null,metadata,meta_key),new cljs.core.Keyword(null,"on-change-fn","on-change-fn",-1237394275),cljs.core.partial.call(null,update_data,meta_key)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),meta_key], null)),velho_ds$molecules$field$file_list_item_$_iter__42982.call(null,cljs.core.rest.call(null,s__42983__$2)));
}
} else {
return null;
}
...
velho_ds.molecules.field.drag_n_drop = (function velho_ds$molecules$field$drag_n_drop(p__42996){
...
var label = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var help_text = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"help-text","help-text",1567653015));
var on_change_fn = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"on-change-fn","on-change-fn",-1237394275));
...
var file_to_map = ((function (files,label_id,map__42997,map__42997__$1,label,help_text,on_change_fn){
...
});})(files,label_id,map__42997,map__42997__$1,label,help_text,on_change_fn))
;
var get_files = ((function (files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (e){
((function (files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42989_SHARP_){
return cljs.core.reset_BANG_.call(null,files,p1__42989_SHARP_);
});})(files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn))
.call(null,((function (files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42988_SHARP_){
return cljs.core.reduce.call(null,velho_ds.molecules.field.add_to_files,cljs.core.deref.call(null,files),p1__42988_SHARP_);
});})(files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn))
.call(null,((function (files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42987_SHARP_){
return cljs.core.map.call(null,file_to_map,p1__42987_SHARP_);
});})(files,label_id,file_to_map,map__42997,map__42997__$1,label,help_text,on_change_fn))
...
;
var file_metadata_changed = ((function (files,label_id,file_to_map,get_files,map__42997,map__42997__$1,label,help_text,on_change_fn){
...
return on_change_fn.call(null,cljs.core.deref.call(null,files));
});})(files,label_id,file_to_map,get_files,map__42997,map__42997__$1,label,help_text,on_change_fn))
;
var remove_item = ((function (files,label_id,file_to_map,get_files,file_metadata_changed,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42990_SHARP_){
cljs.core.swap_BANG_.call(null,files,cljs.core.dissoc,p1__42990_SHARP_);

return on_change_fn.call(null,cljs.core.deref.call(null,files));
});})(files,label_id,file_to_map,get_files,file_metadata_changed,map__42997,map__42997__$1,label,help_text,on_change_fn))
;
return ((function (files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.drag_n_drop_header),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),label], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.call(null,stylefy.core.use_style.call(null,velho_ds.molecules.style.field.drag_n_drop_content),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408),((function (files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42991_SHARP_){
return p1__42991_SHARP_.preventDefault();
});})(files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
,new cljs.core.Keyword(null,"on-drag-enter","on-drag-enter",-1692112235),((function (files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42992_SHARP_){
return p1__42992_SHARP_.preventDefault();
});})(files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
,new cljs.core.Keyword(null,"on-drag-start","on-drag-start",-47712205),((function (files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42993_SHARP_){
return p1__42993_SHARP_.dataTransfer.setData("text/plain","");
});})(files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491),((function (files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (p1__42994_SHARP_){
p1__42994_SHARP_.preventDefault();

return get_files.call(null,p1__42994_SHARP_.dataTransfer);
});})(files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
...
return (function velho_ds$molecules$field$drag_n_drop_$_iter__42999(s__43000){
return (new cljs.core.LazySeq(null,((function (files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (){
var s__43000__$1 = s__43000;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__43000__$1);
if(temp__5457__auto__){
var s__43000__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__43000__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__43000__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__43002 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__43001 = (0);
while(true){
if((i__43001 < size__4291__auto__)){
var key = cljs.core._nth.call(null,c__4290__auto__,i__43001);
cljs.core.chunk_append.call(null,b__43002,(function (){var file_item = cljs.core.get.call(null,cljs.core.deref.call(null,files),key);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [velho_ds.molecules.field.file_list_item,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"filename","filename",-1428840783),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(file_item),new cljs.core.Keyword(null,"metadata","metadata",1799301597),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(file_item),new cljs.core.Keyword(null,"filename","filename",-1428840783),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(file_item)], null),new cljs.core.Keyword(null,"on-change-fn","on-change-fn",-1237394275),cljs.core.partial.call(null,file_metadata_changed,key),new cljs.core.Keyword(null,"delete-fn","delete-fn",-1787555591),((function (i__43001,file_item,key,c__4290__auto__,size__4291__auto__,b__43002,s__43000__$2,temp__5457__auto__,files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (){
return remove_item.call(null,key);
});})(i__43001,file_item,key,c__4290__auto__,size__4291__auto__,b__43002,s__43000__$2,temp__5457__auto__,files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),key], null));
})());

var G__43003 = (i__43001 + (1));
i__43001 = G__43003;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__43002),velho_ds$molecules$field$drag_n_drop_$_iter__42999.call(null,cljs.core.chunk_rest.call(null,s__43000__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__43002),null);
}
} else {
var key = cljs.core.first.call(null,s__43000__$2);
return cljs.core.cons.call(null,(function (){var file_item = cljs.core.get.call(null,cljs.core.deref.call(null,files),key);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [velho_ds.molecules.field.file_list_item,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"filename","filename",-1428840783),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(file_item),new cljs.core.Keyword(null,"metadata","metadata",1799301597),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(file_item),new cljs.core.Keyword(null,"filename","filename",-1428840783),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(file_item)], null),new cljs.core.Keyword(null,"on-change-fn","on-change-fn",-1237394275),cljs.core.partial.call(null,file_metadata_changed,key),new cljs.core.Keyword(null,"delete-fn","delete-fn",-1787555591),((function (file_item,key,s__43000__$2,temp__5457__auto__,files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn){
return (function (){
return remove_item.call(null,key);
});})(file_item,key,s__43000__$2,temp__5457__auto__,files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),key], null));
})(),velho_ds$molecules$field$drag_n_drop_$_iter__42999.call(null,cljs.core.rest.call(null,s__43000__$2)));
}
} else {
return null;
}
...
get_files.call(null,p1__42995_SHARP_.target);

return p1__42995_SHARP_.target.value = null;
});})(files,label_id,file_to_map,get_files,file_metadata_changed,remove_item,map__42997,map__42997__$1,label,help_text,on_change_fn))
