...
velho_ds.molecules.field.create_input_field = (function velho_ds$molecules$field$create_input_field(p__42978,input_type){
...
var change = ((function (input_text,state,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles){
return (function (val){
...
});})(input_text,state,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles))
;
var blur = ((function (input_text,state,change,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles){
return (function (){
...
});})(input_text,state,change,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles))
;
var focus = ((function (input_text,state,change,blur,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles){
return (function (){
...
});})(input_text,state,change,blur,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles))
;
return ((function (input_text,state,change,blur,focus,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42987),velho_ds$molecules$field$create_input_field_$_iter__42984.call(null,cljs.core.chunk_rest.call(null,s__42985__$2)));
} else {
...
return cljs.core.cons.call(null,cljs.core.into.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),stylefy.core.use_sub_style.call(null,velho_ds.molecules.style.field.validation_errors,new cljs.core.Keyword(null,"p","p",151049309)),message], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),message], null))),velho_ds$molecules$field$create_input_field_$_iter__42984.call(null,cljs.core.rest.call(null,s__42985__$2)));
}
} else {
return null;
}
...
;})(input_text,state,change,blur,focus,map__42979,map__42979__$1,label,content,placeholder,icon_click_fn,on_change_fn,on_blur_fn,on_focus_fn,styles))
});
...
,"required"]))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [velho_ds.atoms.icon.clickable,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),(cljs.core.truth_(icon_click_fn)?((function (map__42999,map__42999__$1,item_list__$1,icon__$1,error_messages__$1,item_list_keys,state,change,blur,list_item_click,key_press_handler_fn,map__42996,map__42996__$1,on_blur_fn,item_list,selected_item,on_change_fn,icon_click_fn,placeholder,disabled,on_item_select_fn,icon,error_messages,on_focus_fn,label,styles){
return (function (){
...
;
var click_in_dropdown_QMARK_ = ((function (state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values){
...
;
var global_click_handler = ((function (state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values){
...
});})(state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values))
;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"dropdown-multiple",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,global_click_handler,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (this$){
return velho_ds.molecules.field.add_event_listener.call(null,(dommy.utils.__GT_Array.call(null,reagent.core.dom_node.call(null,this$).getElementsByTagName("input"))[(0)]),new cljs.core.Keyword(null,"focus","focus",234677911),((function (state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,global_click_handler,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"focus","focus",234677911),true);
});})(state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,global_click_handler,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values))
);
});})(state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,global_click_handler,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values))
...
,new cljs.core.Keyword(null,"selected-items","selected-items",-558712488).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,state))))], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_multiple_input_background),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),stylefy.core.use_style.call(null,velho_ds.molecules.style.field.dropdown_multiple_input,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (state,dropdown_id,input_value_changed_fn,list_item_selected_fn,selected_list_item_selected_fn,selectable_items,filtered_selections,key_press_handler_fn,click_in_dropdown_QMARK_,global_click_handler,map__43035,map__43035__$1,label,placeholder,selected_fn,options,preselected_values){
