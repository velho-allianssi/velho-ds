    ...
    (fn []
      [:div
       ...
       [props-table [{:name "disabled"
                     ...
                     {:name "items"
                      :desc "atom"
                      :example "{:items (r/atom [\"foo\" \"bar\"])}"}
                     {:name "on-blur"
                      :desc "function"
                      :example "{:on-blur (fn [e] (println e))}"}
                     {:name "on-focus"
                      :desc "function"
                      :example "{:on-focus (fn [e] (println e))}"}
                     {:name "on-change"
                      :desc "function"
                      :example "{:on-change (fn [e] (println \"Items selected: \" e)"}
                     {:name "placeholder"
                      :desc "string"
                      :example "{:placeholder \"Type something\"}"}
                     {:name "transform-fn"
                      :desc "function"
                      :example "{:transform-fn (fn [e] (println (string/capitalize e)))}"}]]
