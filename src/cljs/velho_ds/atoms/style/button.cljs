...
(def small {:height (measures/rem-times spacing/space-small-rem 2)
            :padding "0 1rem"})

(def dark {:background (str "linear-gradient(-45deg," color/color-neutral-5 "0%," color/color-neutral-4 " 100%)")
           :background-color color/color-primary})

(def outline {:color color/color-primary
...
(def double {:user-select "none"
             :margin "0"
             :width spacing/space-large})

(def upper {:position "relative"
            ::stylefy/mode {:hover {:background color/color-neutral-1}
                            :active {:background color/color-neutral-2
